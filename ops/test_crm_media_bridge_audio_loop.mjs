...
assert.ok(bridge.includes("CRM_MEDIA_BRIDGE_PLAYBACK_RANGE_SAFE_V14"));
...
assert.ok(page.includes("crm-media-bridge.js?v=20260803-audio-playback-v14"), "a URL do bridge precisa invalidar o cache do navegador");
