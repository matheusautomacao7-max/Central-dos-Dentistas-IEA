        ...
        if export_csv:
            ...
            for row in data:
                ...
                export_rows.append({
                    ...
                    "Recuperacao de paciente": "Sim" if row.get("is_recovery") else "N\\u00e3o",
