...
(function () {
  ...
  function icon(name) {
    var paths = {
      ...
      attachment: '<path d="M16.5 7.8V16a4.5 4.5 0 0 1-9 0V7.5a3 3 0 1 1 6 0V15a1.5 1.5 0 1 1-3 0V8.4"/>',
  ...
  function injectCss() {
    ...
    style.textContent = [
      '.iea-lia-launcher{position:fixed;right:22px;bottom:24px;width:56px;height:56px;border:2px solid #e7c87c;border-radius:18px;background:linear-gradient(145deg,#0a2f49,#0f4664);color:#f7d98c;box-shadow:0 13px 30px rgba(6,35,55,.32),inset 0 1px 0 rgba(255,255,255,.16);display:grid;place-items:center;z-index:280;cursor:pointer;transition:transform .18s ease,box-shadow .18s ease}',
      '.iea-lia-launcher:hover{transform:translateY(-2px);box-shadow:0 18px 35px rgba(6,35,55,.42),inset 0 1px 0 rgba(255,255,255,.2)}.iea-lia-launcher svg{width:27px;height:27px;fill:none;stroke:currentColor;stroke-width:1.9;stroke-linecap:round;stroke-linejoin:round}',
      '.iea-lia-panel{--lia-navy:#0a2f49;--lia-navy-soft:#eaf2f6;--lia-gold:#c6a15b;--lia-ink:#16354a;--lia-muted:#64798a;position:fixed;right:0;top:0;bottom:0;width:min(420px,100vw);background:#f9fbfc;box-shadow:-18px 0 48px rgba(5,35,54,.2);z-index:300;transform:translateX(106%);opacity:0;pointer-events:none;transition:transform .26s cubic-bezier(.2,.8,.2,1),opacity .18s ease;display:flex;flex-direction:column;color:var(--lia-ink);font-family:Inter,system-ui,-apple-system,Segoe UI,sans-serif}.iea-lia-panel.is-open{transform:translateX(0);opacity:1;pointer-events:auto}',
      '.iea-lia-head{padding:18px 19px 16px;border-bottom:1px solid #dce8ee;background:linear-gradient(100deg,#fff,#f3f8fa);display:flex;align-items:center;gap:11px}.iea-lia-avatar{width:42px;height:42px;display:grid;place-items:center;border-radius:14px;color:#f7d98c;background:linear-gradient(145deg,#082a42,#15506d);box-shadow:0 8px 18px rgba(10,47,73,.22),inset 0 0 0 1px rgba(231,200,124,.34)}.iea-lia-avatar svg{width:22px;height:22px;fill:none;stroke:currentColor;stroke-width:2;stroke-linecap:round;stroke-linejoin:round}.iea-lia-title{font-size:14px;font-weight:850;line-height:1.2;color:var(--lia-navy)}.iea-lia-title small{display:block;margin-top:3px;color:var(--lia-muted);font-size:11px;font-weight:600}.iea-lia-head-actions{margin-left:auto;display:flex;gap:6px}.iea-lia-icon-btn{width:35px;height:35px;border:1px solid #d5e2e9;background:#fff;border-radius:11px;display:grid;place-items:center;color:#385a6d;cursor:pointer;transition:background .15s ease,border-color .15s ease}.iea-lia-icon-btn:hover{background:#f1f6f8;border-color:#b9ced9}.iea-lia-icon-btn svg{width:17px;height:17px;fill:none;stroke:currentColor;stroke-width:2;stroke-linecap:round;stroke-linejoin:round}',
      '.iea-lia-body{flex:1;min-height:0;overflow-y:auto;padding:22px 19px 16px}.iea-lia-intro{position:relative;overflow:hidden;border:1px solid #d9e8ee;background:linear-gradient(135deg,#ffffff,#edf5f7);border-radius:17px;padding:16px;color:#526b7c;font-size:13px;line-height:1.5;box-shadow:0 7px 18px rgba(14,62,84,.05)}.iea-lia-intro:before{content:"";position:absolute;top:0;left:0;width:4px;height:100%;background:linear-gradient(#d8b76b,#a67b2d)}.iea-lia-intro strong{color:var(--lia-navy)}.iea-lia-section{margin-top:25px}.iea-lia-section h3{margin:0 0 11px;font-size:11px;text-transform:uppercase;letter-spacing:.09em;color:#6a7d89}.iea-lia-suggestions{display:grid;gap:8px}.iea-lia-suggestion{width:100%;border:1px solid transparent;background:transparent;text-align:left;padding:10px 11px;border-radius:10px;color:#244457;font-weight:700;font-size:13px;cursor:pointer;transition:background .15s ease,border-color .15s ease,color .15s ease}.iea-lia-suggestion:before{content:"↳";margin-right:8px;color:#b18535;font-size:16px}.iea-lia-suggestion:hover{background:#f2f7f8;border-color:#dce9ed;color:var(--lia-navy)}',
      '.iea-lia-messages{display:grid;gap:12px}.iea-lia-message{max-width:92%;padding:12px 13px;border-radius:15px;font-size:13px;line-height:1.48;white-space:pre-wrap}.iea-lia-message.user{justify-self:end;color:#fff;background:linear-gradient(135deg,#0b3652,#176181);border-bottom-right-radius:5px}.iea-lia-message.assistant{background:#eef5f6;color:#244457;border:1px solid #dce9ed;border-bottom-left-radius:5px}.iea-lia-source{margin-top:8px;display:inline-flex;align-items:center;gap:5px;border-radius:999px;background:#fbf3df;color:#8b631b;padding:4px 8px;font-size:10px;font-weight:800}.iea-lia-loading{color:#718096;font-size:12px;padding:9px 2px}.iea-lia-error{margin-top:12px;padding:10px 12px;background:#fff2f2;color:#b42318;border-radius:10px;font-size:12px}',
      '.iea-lia-form{padding:14px 15px 16px;border-top:1px solid #dbe7ec;background:#fff}.iea-lia-filelist{min-height:17px;margin:0 0 8px;font-size:11px;color:#657f95;line-height:1.35;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.iea-lia-form-row{display:flex;gap:9px;align-items:flex-end}.iea-lia-attach{width:45px;height:45px;border:1px solid #d3e2e8;background:#fff;border-radius:13px;display:grid;place-items:center;color:#385a6d;cursor:pointer}.iea-lia-attach:hover{background:#f3f8fb;border-color:#b8d0de}.iea-lia-attach input{display:none}.iea-lia-attach svg{width:19px;height:19px;fill:none;stroke:currentColor;stroke-width:2;stroke-linecap:round;stroke-linejoin:round}.iea-lia-form textarea{min-height:48px;max-height:110px;resize:none;flex:1;border:1px solid #cfdee5;border-radius:13px;padding:13px;font:inherit;font-size:13px;outline:0;color:#213f51;background:#fbfdfe}.iea-lia-form textarea:focus{border-color:#b78a39;box-shadow:0 0 0 3px rgba(198,161,91,.18)}.iea-lia-send{width:45px;height:45px;border:0;border-radius:13px;background:linear-gradient(145deg,#0b3a57,#155c7c);color:#f7d98c;box-shadow:0 6px 13px rgba(8,47,72,.18);display:grid;place-items:center;cursor:pointer}.iea-lia-send:hover{filter:brightness(1.08)}.iea-lia-send:disabled{opacity:.45;cursor:not-allowed}.iea-lia-send svg{width:19px;height:19px;fill:none;stroke:currentColor;stroke-width:2;stroke-linecap:round;stroke-linejoin:round}',
      '.iea-lia-manager-note{font-size:12px;color:#657b88;line-height:1.45;margin-bottom:15px}.iea-lia-new{width:100%;padding:11px;border:1px solid #d9e8ee;border-radius:11px;background:#edf5f7;color:#16425c;font-weight:850;cursor:pointer}.iea-lia-new:hover{background:#e1eef2;border-color:#bed5df}.iea-lia-list{display:grid;gap:9px;margin-top:13px}.iea-lia-article{width:100%;text-align:left;border:1px solid #dbe7ec;background:#fff;border-radius:12px;padding:12px;cursor:pointer}.iea-lia-article:hover{border-color:#bad1dc;background:#f8fbfc}.iea-lia-article strong{display:block;font-size:13px;color:#1d4054}.iea-lia-article span{display:flex;gap:6px;align-items:center;margin-top:6px;font-size:11px;color:#708492}.iea-lia-status{border-radius:999px;padding:2px 7px;background:#ecfdf3;color:#137a43;font-weight:800}.iea-lia-status.draft{background:#fff7e6;color:#aa6a00}.iea-lia-status.archived{background:#eef1f5;color:#667085}.iea-lia-field{display:grid;gap:6px;margin-bottom:13px}.iea-lia-field label{font-size:11px;font-weight:800;color:#3c5a6c}.iea-lia-field input,.iea-lia-field select,.iea-lia-field textarea{width:100%;box-sizing:border-box;border:1px solid #d4e2e8;border-radius:10px;padding:10px;font:inherit;font-size:13px;outline:0;background:#fff}.iea-lia-field input:focus,.iea-lia-field select:focus,.iea-lia-field textarea:focus{border-color:#b78a39;box-shadow:0 0 0 3px rgba(198,161,91,.16)}.iea-lia-field textarea{height:215px;resize:vertical}.iea-lia-save{width:100%;border:0;border-radius:11px;padding:12px;color:#fff;background:linear-gradient(145deg,#0b3a57,#155c7c);font-weight:850;cursor:pointer}.iea-lia-save:hover{filter:brightness(1.08)}',
      '@media(max-width:700px){.iea-lia-launcher{right:16px;bottom:18px}.iea-lia-panel{width:100vw}.iea-lia-body{padding:18px 16px}}@media(prefers-reduced-motion:reduce){.iea-lia-launcher,.iea-lia-panel,.iea-lia-icon-btn,.iea-lia-suggestion{transition:none!important}}'
    ].join('');
  ...
  function ensurePanel() {
    ...
    panel.querySelector('[data-lia-close]').addEventListener('click', function (event) {
